...
org.simpo.svnk = function() {
    ...
    this._saveDirtyPaths = function(paths) {
        // summary:
    ...
    this._handleDirtyFiles = function(type) {
        ...
        if (dirtyPaths.length > 0) {
            ...
            return this._respondDirtyResponse(type,command,dirtyPaths);
        }
    ...
    this._respondDirtyResponse = function(type,command,paths) {
        // summary:
